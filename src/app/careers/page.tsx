...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		description:
			"Discover exciting career opportunities at ClimateForge, where we innovate the way contractors find leads for solar, HVAC, and green industries.",
...
export default function Careers() {
	...
	return (
		<main className="flex min-h-screen flex-col items-center py-12 pt-14 sm:pt-24">
			{/* title card and CTA */}
			<Title
				title={["Make an", "Impact in the World!"]}
				description={
					"We are here to solve the biggest climate challenges of our time"
				}
				descriptionAnimated={[
					"We are here to solve the biggest ",
					"climate",
					"energy",
