		...
		<div className="container mx-auto px-4 py-8 max-w-4xl">
			...
			<div className="prose prose-lg max-w-none">
				...
				<ul className="list-disc pl-6 my-4">
					...
					<li className="mb-2">
						<strong>Website</strong> refers to climateforge,
						accessible from climateforge.ai
					</li>
					<li className="mb-2">
				...
				<h4 className="text-lg font-medium mt-5 mb-2">Personal Data</h4>
				<p className="my-4">
				...
				<h4 className="text-lg font-medium mt-5 mb-2">Usage Data</h4>
				<p className="my-4">
				...
				<ul className="list-disc pl-6 my-4">
					<li className="mb-2">Type: Session Cookies</li>
					<li className="mb-2">Administered by: Us</li>
					<li className="mb-2">
				...
				<ul className="list-disc pl-6 my-4">
					<li className="mb-2">Type: Persistent Cookies</li>
					<li className="mb-2">Administered by: Us</li>
					<li className="mb-2">
				...
				<ul className="list-disc pl-6 my-4">
					<li className="mb-2">By email: team@climateforge.ai</li>
				</ul>
			</div>
		</div>
	);
