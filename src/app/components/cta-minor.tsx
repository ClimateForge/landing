	...
	return (
		<div className="relative w-full h-full flex flex-col justify-center p-8 border border-[#E0DFE2] text-xs sm:text-sm md:text-base bg-white rounded-[15px] shadow-lg hover:border-primary">
			<Image
				...
				height={36}
			/>
			<h5 className="text-[#858585] text-base sm:text-lg lg:text-lg font-bold">
				{title}
			</h5>
		...
		<section className="relative flex flex-col justify-center items-center w-full max-w-[1440px] p-4 ">
			...
			>
				<h2 className=" relative leading-snug">
					Empowering <GradientText>American Businesses</GradientText>{" "}
					to Sell More Energy Upgrades
				</h2>
				<p className="text-base sm:text-lg max-w-[666px] pb-10 font-medium">
					Identify the optimal residential heating and cooling for
					efficiency, deploy Solar, HVAC, and energy storage systems
					and make real money faster.
				</p>
				...
				>
					...
					>
						...
						<motion.div
							...
							className="absolute flex justify-center z-30 top-[20%] left-[10%] backdrop-blur-sm w-[100px] lg:w-[136px] "
						>
							<Image
							...
							<motion.div
								variants={leftVariants}
								className="absolute z-40 top-[20%] w-[70px] lg:w-[95px]"
							>
								<Image
						...
						<motion.div
							...
							className="absolute top-[20%] right-[10%] w-[100px] lg:w-[180px] z-30 "
						>
							<Image
