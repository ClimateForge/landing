...
function UspDecoration({
	...
	return (
		<>
			...
			>
				<div
					className={`${inter.className}  flex flex-col justify-center cursor-default`}
				>
					<p className="text-[12px] text-[#A9A7B6] leading-5">
						{caption}
					</p>
            ...
            rounded-[10px] bg-white shadow-md"
				>
					<Image
						...
						src={"/landing/usp-list/avatar.webp"}
						sizes="100vh"
						alt="Avatar"
						width={0}
						height={0}
					/>
					<div
						className={`${inter.className} flex flex-col justify-center h-[32px] px-[9px]`}
					>
						<p className="text-[14px] font-bold">+7.25%</p>
						<p className="text-[11px] font-medium leading-none text-[#A9A7B6]">
							Increase in Clients
						</p>
					</div>
					...
					<Image
						...
						src={"/landing/usp-list/icon-line-graph.svg"}
						alt="Line Graph SVG"
						width={0}
						height={0}
					/>
...
function UspImage({ src, iconSrc, accentVariant, children }: USPImageProps) {
	...
	return (
		...
		>
			...
			>
				<div
					className="full min-w-[220px] max-w-[370px] max-h-[370px]
                    overflow-hidden opacity-45 sm:opacity-100 rounded-full"
				>
					<video
						className="full aspect-square object-cover"
						src={src}
						autoPlay
						loop
						playsInline
			...
			<motion.img
				variants={fromRight}
				title="Small Green Dot"
				alt="Small Green Dot SVG"
				src={"/landing/usp-list/dot-small.svg"}
				width={21}
				height={21}
			...
			<motion.img
				variants={fromLeft}
				title="Large Green Dot"
				alt="Large Green Dot SVG"
				src={"/landing/usp-list/dot-large.svg"}
				width={65}
				height={66}
...
function UspBlock({
	...
	return (
		<div
			className="relative flex flex-col text-center sm:text-left sm:flex-row items-center justify-center rounded-15 px-[25px] md:px-[50px] py-[58px]"
			style={{ backgroundColor: color }}
		>
			<div
				className="flex flex-col z-10 pr-[52px] pb-4 sm:pb-0 gap-4 sm:gap-6 md:gap-8 lg:gap-12"
...
const uspData = [
	{
		...
		description: [
			"Companies using ClimateForge's solutions experience a ",
			"55%",
			" faster time to deploy energy upgrades.",
		],
		videoSrc: "/landing/usp-list/conversion-optimized.mp4",
		iconSrc: "/landing/usp-list/icon-react.svg",
		uspDecoration: [
			"$245.00",
			"Total Income",
			"/landing/usp-list/icon-bar-graph.svg",
		],
		color: "#CFDDDC",
	},
	{
		...
		description: [
			"ClimateForge's technology has led to a significant ",
			"32%",
			" increase in renewable energy adoption.",
		],
		videoSrc: "/landing/usp-list/real-energy-modeling.mp4",
		iconSrc: "/landing/usp-list/icon-ai.svg",
		accentVariant: true,
		uspDecoration: [
			"Efficiency",
			"Savings",
			"/landing/usp-list/icon-robot.svg",
		],
		color: "#C1CDE2",
	},
	{
		...
		description: [
			"Businesses using ClimateForge help to reduce carbon emissions by more than ",
			"30%",
			".",
		],
		videoSrc: "/landing/usp-list/impact-assessments.mp4",
		iconSrc: "/landing/usp-list/icon-sustainable.svg",
		uspDecoration: [
			"Save Earth",
			"Make $",
			"/landing/usp-list/icon-sun.svg",
		],
		color: "#EDEDED",
	},
];
