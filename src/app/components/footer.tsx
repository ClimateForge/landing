		...
		<footer className="text-dark-secondary py-10">
			<div className="flex flex-col justify-center items-center mx-4">
				...
				<div className="flex flex-col sm:flex-row w-full max-w-[1180px] justify-between">
					...
					{/* Links */}
					<div
						className="flex flex-wrap sm:justify-center sm:items-center sm:mx-6 gap-x-6 sm:gap-x-8 mb-8 sm:mt-0
					...
					>
						...
						<EmailButton link>Contact Us</EmailButton>
					</div>
					...
					<div className="flex flex-wrap gap-4 sm:justify-center sm:items-center text-primary">
						...
						<Link
							title="LinkedIn"
							href={
								"https://www.linkedin.com/company/climateforge/?viewAsMember=true"
							}
				...
				{/* Bottom Row */}
				<div
					className={`flex justify-between gap-y-4 items-center
