    ...
    const infoBlocks = [
        {
            ...
            image: '/info-scroll/discover-quality-leads.gif',
        ...
        },
        {
            ...
            image: '/info-scroll/crm-assistance.gif',
        ...
        },
        {
            ...
            image: '/info-scroll/energy-assessment.gif',
        ...
        },
        {
            ...
            image: '/info-scroll/system-design.gif',
            ...
            <div className="flex w-full
                ...
                <div className="sticky top-[20%] hidden sm:block">
                    ...
                    <Image
                        ...
                        className="object-contain max-w-[630px] rounded-15"
                        width={0}
                        height={0}
                        sizes="100vw"
