...
export default function Demo({ videoSrc }: DemoProps) {
	...
	return (
		<section
			className="group rounded-2xl transition-opacity group-hover:opacity-90 h-full max-w-[1280px] w-full pt-20"
			style={{
				backgroundImage:
					"linear-gradient(180deg, rgba(255, 255, 255, 0.55), rgba(92, 177, 140, 0.2035), rgba(70, 146, 184, 0.506), rgba(91, 88, 199, 0.33))",
			}}
		>
			{/* Image with Play Button */}
			<div className="relative flex justify-center items-center px-4 md:px-8">
				<Image
					src="/landing/demo-image.png"
					alt="Product Image"
					title="Product image"
					width={1280}
					height={520}
				...
				>
					<motion.div
						...
						className="absolute rounded-full gradient-border "
			...
			<Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
				<div className="relative w-full max-w-[1280px]">
					<video
						controls
						autoPlay
						className="w-full max-w-[1280px] rounded-lg"
					>
