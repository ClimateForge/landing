	...
	const teamMembers = [
		{
			...
			image: "/landing/our-team/ceo.webp",
			socials: {
				instagram: "",
		...
		},
		{
			...
			image: "/landing/our-team/team-member2.png",
			socials: {
				instagram: "",
		...
		},
		{
			name: "Bella",
			title: "Supreme COO",
			image: "/landing/our-team/coo.webp",
			socials: {
				instagram: "",
				linkedIn: "",
				facebook: "",
		...
		<section className="flex flex-col justify-center items-center pt-10 md:pt-20 pb-20 md:pb-40">
			...
			<div className="flex flex-wrap justify-center gap-y-8 sm:gap-y-12 md:gap-y-16 gap-x-14">
				{teamMembers.map((teamMember, index) => (
					<div
						key={index}
						className="flex shadow-[12px_12px_16px_-9px_#44A3CF2E] rounded-[65px]
