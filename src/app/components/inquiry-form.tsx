...
const businessOptions = ["Door to Door", "Phone Calls", "Emails"];
...
export default function InquiryForm({ isOpen, setIsOpen }: InquiryFormProps) {
	...
	const validateForm = () => {
		...
		if (formData.productTypes.length === 0)
			newErrors.productTypes = "Select at least one product";
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
					<div className="bg-gradient-to-br from-white to-blue-50 rounded-2xl p-4 max-w-xl w-full max-h-[90vh] overflow-hidden">
						<div className="flex justify-between items-center mb-4 sticky top-0 bg-gradient-to-br from-white to-blue-50 py-2 z-10 border-b border-blue-100">
							<h2 className="text-2xl font-bold text-[#21606A]">
								Inquiry Form
							</h2>
							<button
						...
						<div className="max-h-[80vh] overflow-y-auto hide-scrollbar">
							<form
								action="https://formsubmit.co/team@climateforge.ai"
								method="POST"
								className="space-y-3"
							>
								...
								<div className="flex gap-4">
									...
									<div className="w-3/4">
										<div
											className={`space-y-2 p-2 border rounded-md ${errors.productTypes ? "border-red-500" : "border-blue-200"}`}
										>
