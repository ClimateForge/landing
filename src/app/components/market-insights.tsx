...
export default function MarketInsights() {
	...
	const lineGraphData = {
		...
		subtitle: "Existing Buildings and Annual Cost",
		description:
			"The DOE aims to reduce building emissions by 65% by 2035 and 90% by 2050. Achieving these targets requires widespread adoption of energy-efficient technologies and clean energy solutions.",
	};
	...
	const cardsInfo = [
		{
			...
			description:
				"There are approximately 130 million buildings in the U.S. with annual energy costs exceeding $400 billion. Upgrading these buildings can significantly reduce costs and environmental impact.",
			color: "#D7DBF6",
		},
		{
			...
			description:
				"By 2050, the U.S. expects 40 million new homes and 60 billion square feet of commercial space. Integrating energy-efficient designs from the start is crucial for long-term sustainability.",
			color: "#CEDCDC",
		},
		{
			...
			description:
				"25% of all households and 50% of low-income households struggle with energy costs. Energy-efficient upgrades can alleviate this financial burden and improve quality of life.",
			color: "#EDEDED",
		},
		{
	...
	return (
		<section
            ...
            bg-[url(/landing/job-openings/solar-panels.webp)] bg-cover bg-center px-4"
		>
