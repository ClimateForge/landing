...
export default function Deploy() {
	const images = [
		...
		{
			src: "energy-storage-batteries",
			caption: "Energy Storage & Batteries",
		},
			...
			<div className="flex justify-center items-center w-full max-w-[1179px] z-20 mt-10">
				<div className="grid grid-cols-2 sm:grid-cols-3 gap-4 w-full">
                    ...
                    rounded-[20px] overflow-hidden"
							>
								<video
									...
									src={`/landing/deploy/${image.src}.mp4`}
                    ...
                    group-hover:rounded-[15px] group-hover:min-h-[70px] "
									...
									onMouseOut={handleMouseOut}
								>
									<div className="flex flex-col sm:flex-row group-hover:flex-row justify-center items-center gap-4 transition-all duration-700 group-hover:gap-2">
										<Image
											title="Deploy Icon"
