...
const featuredArticles = [
	{
		name: "Times",
		logo: "/landing/logos/the-industry-times-logo.png",
	...
	{
		name: "LA Tribune",
		logo: "/landing/logos/cropped-latribune.png",
	...
	{
		name: "Amplify Weekly",
		logo: "/landing/logos/amplify-logo.png",
...
export default function Featured() {
	...
	return (
		<div className="max-w-[1280px] mt-8 mx-auto px-4">
			...
			<p className="text-2xl sm:text-3xl mb-6 text-center font-bold">
				Featured In
			</p>
					...
					>
						<div className="bg-purple-100 p-4 rounded-lg flex justify-center items-center w-full">
							<Image
								...
								alt={article.name}
								width={
									article.name === "LA Tribune"
										? 500
										: article.name === "Amplify Weekly"
											? 80
											: 140
								}
								height={
									article.name === "LA Tribune" ? 150 : 60
								}
